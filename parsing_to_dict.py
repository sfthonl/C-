...
class BlocksOfRule:
    ...
    def init_blocks(cls):
        ...
        cls.register = pp.Combine(
            ...
            pp.Optional("(") + pp.CaselessLiteral("R") +
            pp.Word(pp.nums) + pp.Optional(")") +
            pp.Optional("+")
        )

        cls.immediate_val = pp.Combine(pp.Optional("@") + "#" + pp.Word(pp.nums))

        cls.register_first_command = cls.register | cls.immediate_val
        cls.register_second_command = cls.register | cls.immediate_val
